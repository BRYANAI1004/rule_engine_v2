# M085 Domain Rule Tree

## Admission

- [OR] Admission is indicated for 1 or more of the following
  - Path: Acute hemorrhagic (eg, intracerebral) stroke ) ) )
    [atomic] Acute hemorrhagic (eg, intracerebral) stroke ) ) )
  ...
  [CHECKLIST] Discharge planning includes
    ...
    [CHECKLIST] Transitions of care plan complete, including ) ) )
      [CHECKLIST] Patient and caregiver education complete.
        ...
        [atomic] See Stroke: Hemorrhagic: Patient Education for Clinicians SR for further information.
